...
const Personas = () => {
  ...
  const [triedPersonas, setTriedPersonas] = useState(false);
  const [triedEventos, setTriedEventos] = useState(false);
  const [triedAportes, setTriedAportes] = useState(false);
  ...
  const [refColumnas1, setRefColumnas1] = useState([
    "id",
    "nombre",
    "edad",
    "estructura",
  ...
  const [refPropsColumnas1, setPropsColumnas1] = useState([
    "",
    "",
    "",
    "nombre",
  ...
  const [alineacionesColumnas1, setAlineacionesColumnas1] = useState([
    "c",
    "l",
    "c",
    "l",
  ...
  const [refColumnas2, setRefColumnas2] = useState([
    "id",
    "nombre",
    "edad",
    "estructura",
  ...
  const [refPropsColumnas2, setPropsColumnas2] = useState([
    "",
    "",
    "",
    "nombre",
  ...
  const [alineacionesColumnas2, setAlineacionesColumnas2] = useState([
    "c",
    "l",
    "c",
    "l",
  ...
  useEffect(() => {
    ...
    const agregarEventosADataPersonas = () => {
      ...
      personasDataRaw1.forEach((persona, i) => {
        ...
        dataEventos.forEach((evento) => {
          idsPersonasEvento = [];
          evento.personas.forEach((personaEv) => {
            idsPersonasEvento.push(personaEv.id);
          });
    ...
    if (
      (!personasDataRaw1.length || !personasDataRaw2.length) &&
      !triedPersonas
    ) {
      getPersonasData();
      setTriedPersonas(true);
    }
    if (!dataEventos.length && !triedEventos) {
      getDataEventos();
      setTriedEventos(true);
    }
    if (!dataAportes.length && !triedAportes) {
      getDataAportes();
      setTriedAportes(true);
    }
